...
A Windows X.509 certificate is used as the basis, which provides the logon data of the Windows AD user. The correctness of this X.509 certificate is ensured via the company's internal certification authority (ca).

{: .box-tip }
**Tip:** The necessary configuration of the X.509 certificate should be implemented by the network team and requires basic knowledge in this area.
...
{: .box-note }
**Note** SNC name represents the full distinguished name from subject of certificate e.g., `E = <Windows AD-user E-mail address>`
