...
|:-----:|:------:|:----------:|:----------|
|6.0.13 [L]|2023-09-22|Server|Parameters for table extractions are with values larger than allowed do now default to the configured values from the extraction.|
