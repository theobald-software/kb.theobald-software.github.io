...
It is not possible to run multiple instances of SAP with the same user in parallel to yunIO.
...
5. Click **[Next]** to execute the selected action. All actions are logged in the sections *GUI Steps* (4).
5. Enter the general data of your equipment. 
6. Add a location to the equipment: <br>Select *[TAB] Location* from the drop-down-menu (3) and click **[Next]**.
*[TAB] Location* corresponds to opening the Location tab in the SAP GUI.
Enter the location data for your equipment.
7. Add a warranty to the equipment: <br>Select *[TAB] Warranty and Partner* from the drop-down-menu (3) and click **[Next]**.
*[TAB] Warranty and Partner* corresponds to opening the Warranty tab in the SAP GUI.
Enter the warranty data of your equipment.
8. Save the equipment: <br>Select *Save* from the drop-down-menu (3) and click **[Next]**.
9. End the process: <br>Select *Exit* from the drop-down-menu (3) and click **[Next]**.
