...
redirect_from:
  - _xtract-universal/runs-an-ADF-pipeline-when-sap-extraction-file-is-successfully-uploaded-to-Azure-storage.md
  - _xtract-universal/running-an-ADF-pipeline-when-sap-extraction-file-is-uploaded-to-Azure-storage.md
weight: 52
---
