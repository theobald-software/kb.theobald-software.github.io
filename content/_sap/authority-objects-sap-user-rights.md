...
{: .box-note }
**Note** Reports not assigned to an authorization group must have a custom authorization object Z_TS_PROG assigned to the user, see [Z_XTRACT_IS_REMOTE_REPORT_README.pdf](/files/Z_XTRACT_IS_REMOTE_REPORT.pdf){:target="_blank"}.
